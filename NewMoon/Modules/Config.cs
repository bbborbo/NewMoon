...
namespace NewMoon.Modules
{
    ...
    public static class Config
    {
        ...
        {
            MyConfig = new ConfigFile(Paths.ConfigPath + $"\\{NewMoonPlugin.modName}.cfg", true); //FortunesPlugin.instance.Config;
            MyConfig.SaveOnConfigSet = false;
            BackupConfig = new ConfigFile(Paths.ConfigPath + $"\\{NewMoonPlugin.modName}.Backup.cfg", true);
